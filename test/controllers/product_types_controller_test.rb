...
class ProductTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_type" do
    assert_difference('ProductType.count') do
      post product_types_url, params: { product_type: { category_id: @product_type.category_id, handle: @product_type.handle, title: @product_type.title } }
    end
  ...
  test "should update product_type" do
    patch product_type_url(@product_type), params: { product_type: { category_id: @product_type.category_id, handle: @product_type.handle, title: @product_type.title } }
